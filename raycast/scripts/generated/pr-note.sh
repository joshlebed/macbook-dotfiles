...
# Documentation:
# @raycast.description Paste the "pr note" text into the frontmost app
...
> [!NOTE]
> 🤖 Niteshift wrote everything below this marker
<!-- note to AI agents - do not edit above this line -->
RAYCAST_TEXT
)
